 ...
 * Initializes the local data file with proper schema structure
 */
...
const dataFile = path.join(dataDir, 'local-data.json')
...
// Initial data structure matching the database schema
const initialData = {
  tournaments: [
    {
      id: '1',
      ...
      photo_urls: ['/images/tournament-stones-2025.svg'],
    ...
    },
    {
      ...
      photo_urls: ['/images/tournament-uncle-joe-2025.svg'],
    ...
    },
    {
      ...
      photo_urls: ['/images/tournament-pga-qualifying-2025.svg'],
    ...
    },
    {
      ...
      photo_urls: ['/images/tournament-korn-ferry-2025.svg'],
    ...
    },
    {
      ...
      photo_urls: ['/images/tournament-spring-classic-2025.svg'],
    ...
    },
    {
      ...
      photo_urls: ['/images/tournament-mini-tour-2025.svg'],
    ...
    },
    {
      ...
      photo_urls: ['/images/tournament-winter-series-2025.svg'],
    ...
    },
    {
      ...
      photo_urls: ['/images/tournament-season-opener-2025.svg'],
  ...
  sponsors: [
    {
      id: '1',
      name: 'Stones Golf',
      logo_url: '/images/sponsor-stones-golf.svg',
      tier: 'Gold',
      website_url: 'https://stonesgolf.com',
    ...
    },
    {
      id: '2',
      name: 'Titleist',
      logo_url: '/images/sponsor-titleist.svg',
      tier: 'Silver',
    ...
    },
    {
      id: '3',
      name: 'Callaway',
      logo_url: '/images/sponsor-callaway.svg',
      tier: 'Silver',
  ...
  merch: [
    {
      ...
      description: 'Show your support with the official Uncle Joe golf cap. Premium quality with embroidered logo.',
      price_id: 'price_cap_001',
      image_url: '/images/merch-cap.svg',
      active: true,
      created_at: '2025-01-01T00:00:00Z',
      updated_at: '2025-01-01T00:00:00Z'
    },
    {
      ...
      description: 'Premium performance polo featuring the Stones Golf logo. Moisture-wicking fabric for all-day comfort.',
      price_id: 'price_polo_001',
      image_url: '/images/merch-polo.svg',
      active: true,
      created_at: '2025-01-01T00:00:00Z',
      updated_at: '2025-01-01T00:00:00Z'
    },
    {
      ...
      description: 'Absorbent microfiber towel perfect for the course. Features embroidered Uncle Joe logo.',
      price_id: 'price_towel_001',
      image_url: '/images/merch-towel.svg',
      active: true,
      created_at: '2025-01-01T00:00:00Z',
      updated_at: '2025-01-01T00:00:00Z'
    }
...
// Write the initial data to file
try {
  fs.writeFileSync(dataFile, JSON.stringify(initialData, null, 2))
  console.log('✅ Local database initialized successfully!')
  console.log(`📁 Data file created at: ${dataFile}`)
  console.log(`📊 Initial data includes:`)
  console.log(`   - ${initialData.tournaments.length} tournaments`)
  console.log(`   - ${initialData.sponsors.length} sponsors`)
  console.log(`   - ${initialData.merch.length} merchandise items`)
} catch (error) {
  console.error('❌ Error initializing local database:', error.message)
  process.exit(1)
}
